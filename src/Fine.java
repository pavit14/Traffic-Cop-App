     ...
     public void doGet(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException 
      {  
         ...
         {  
             ...
             ResultSet rs = stmt.executeQuery("select * from finecollected order by date desc ");  
             out.println("<h1>Fine Details</h1>\r\n" + 
             ...
             {  String m = rs.getString("date");  
                ...
                String  b= rs.getString("license");
                 String  v= rs.getString("violation");  
                 String c = rs.getString("fine");  
                    
                 out.println("<tr><td>" + m + "</td><td>" + n + "</td><td>" + b + "</td><td>" + v + "</td><td>" + c +"</td></tr>");   
             }  
