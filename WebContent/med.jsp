  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        <a href="med.jsp" class="list-group-item list-group-item-action bg-light">Emergency Details</a>
      </div>
    </div>
    <!-- /#sidebar-wrapper -->
...
ps=connection.prepareStatement("select * from emergency order by date desc");
...
<td><%=resultSet.getString("long") %></td>
</tr>
<%
}
connection.close();
