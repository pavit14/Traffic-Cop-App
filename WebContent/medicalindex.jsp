...
<head>
	<title>Medical Team Login Page</title>
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('images/img.jpg');">
			<div class="wrap-login100 p-t-190 p-b-30">
				<form class="login100-form validate-form" action="medicallogin" method="post">
					<div class="login100-form-avatar">
						<img src="images/medico.png" alt="AVATAR">
					</div>
                  ...
                  <tr><td>${successmessage}</td></tr></table>
					...
					<div class="text-center w-full p-t-25 p-b-230">
						<a href="medicalregister.jsp" class="txt1">
							Register here
