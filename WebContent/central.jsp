...
<head>
  ...
  <title>Central Team Dashboard</title>
...
ps=connection.prepareStatement("select * from violations order by dt desc");
...
<td><%=resultSet.getString("vtype") %></td>
<td><%=resultSet.getString("registration_no") %></td>
<td><%=resultSet.getString("vcolor") %></td>
<td><%=resultSet.getString("vehicle") %></td>
<td><%=resultSet.getString("loc_lat") %></td>
<td><%=resultSet.getString("loc_long") %></td>
<td><%=resultSet.getString("offender") %></td>
